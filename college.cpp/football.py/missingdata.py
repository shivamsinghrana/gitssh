...
path = 'C:/Users/sk545/Downloads/chromedriver-win64 (1).zip/chromedriver-win64'
service = Service(executable_path=path)
driver = webdriver.Chrome()
#query='score'
driver.get(f"https://www.adamchoi.co.uk/overs/detailed")
#elem= driver.find_element(By.NAME,"all")
#driver = webdriver.Chrome()
